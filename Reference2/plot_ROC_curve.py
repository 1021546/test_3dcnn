...
save_path = os.path.join(os.path.dirname(os.path.abspath(__file__)),'ROC.jpg')
Plot_ROC_Fn(label,score,save_path)
save_path = os.path.join(os.path.dirname(os.path.abspath(__file__)),'PR.jpg')
Plot_PR_Fn(label,score,save_path)
save_path = os.path.join(os.path.dirname(os.path.abspath(__file__)),'Histogram.jpg')
