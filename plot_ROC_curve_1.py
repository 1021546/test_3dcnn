...
score = np.load(os.path.join(os.path.dirname(os.path.abspath(__file__)),'./evaluation_data/score_vector.npy'))
label = np.load(os.path.join(os.path.dirname(os.path.abspath(__file__)),'./evaluation_data/target_label_vector.npy'))
...
save_path = os.path.join(os.path.dirname(os.path.abspath(__file__)),'./plot_figure/ROC.jpg')
Plot_ROC_Fn(label,score,save_path)
save_path = os.path.join(os.path.dirname(os.path.abspath(__file__)),'./plot_figure/PR.jpg')
Plot_PR_Fn(label,score,save_path)
save_path = os.path.join(os.path.dirname(os.path.abspath(__file__)),'./plot_figure/Histogram.jpg')
Plot_HIST_Fn(label,score,save_path)